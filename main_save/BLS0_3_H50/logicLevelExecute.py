...
def niftyFifty():
    ...
    CurrentNiftyValue = currentPrice
    ...
    return AlgoStartDate.date(), AlgoStartDateNiftyClose, CurrentNiftyValue, quantityNifty, niftyMTM, netProfit, niftyMtmPercentage, niftynetProfitPercentage, (max_drawdown*100)
            ...
            while True:
                ...
                if (currentHour != lastPrintHour) or (algoStart == True):
                    ...
                    try:
                        ...
                        AlgoStartDate, AlgoStartDateNiftyClose, CurrentNiftyValue, quantityNifty, niftyMTM, netProfit, niftyMtmPercentage, niftynetProfitPercentage, max_drawdown = niftyFifty()
...
# START DATE: 2025-03-06 | INDEX START VALUE: 22552.5 | Qty: 66
# NIFTY: [MTM: 15583[1.0%] | NET P/L: 113715[7.6%] | Max DD: [10%]]
# Algo:  [MTM: 15583[1.0%] |  NET P/L: 113715[7.6%] | Max DD: [10%]]
# INVESTED: 1544348[103.0%] | CURRENT: 1625083[108.3%] | TOTAL: 1500000
